...
"东境·茂密林海"式区域浮现)、随机遗迹(废弃营地、无名石碑的金币环)、野生狼群。
骑马向任一方向狂奔十分钟,风景仍在变化。
...
**📚 65 万字对话库**(`src/dialogue-db.json`,21,000+ 行):26 位角色
...
每 45~105 秒,事件导演从事件池按**权重 × 条件**(时辰/位置/主线进度)抽一个
在你身边上演,永不停歇:
...
**12 种事件无限轮换**。竞技场比赛期间导演自动停手。

## 🤖 运行时 AI 创作(联网时)

- **吟游诗人皮波**的《你的歌》由**文本 AI 现场作词**——把你的实时战绩
  (通缉星数、狼杀数、金币数、委托进度)喂给 AI 写四行打油诗,每次都不一样
- **疯子老糊涂**的第四面墙预言也交给 AI 即兴发挥
- 与贴图一样走免费无 Key 接口,**断网瞬间回退**到内置台词,游戏永不卡壳

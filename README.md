...
游戏内置 **AI 贴图管线**:把 AI 生成的无缝贴图放进 `assets/ai/` 目录,
启动时自动加载替换程序化贴图,法线贴图由图像亮度自动推导,零配置。
支持草地/鹅卵石/石砖/屋瓦/灰泥/木纹/土路 7 种贴图 + 标题画面键艺术。

👉 每张贴图的**现成生图提示词**(Midjourney / Stable Diffusion / DALL·E 可直接用)
见 [`assets/ai/README.md`](assets/ai/README.md)。
